...
const sectionsData = [
  ...
  },
  {
    ...
    products:[
      {id:'b-1',img:'best-ghost-1.jpg',title:'Ghost Pepper Powder',price:'$49/kg – Free Delivery',desc:'Smoked and powder options.'},
      {id:'b-2',img:'best-lakadong-1.jpg',title:'Lakadong Turmeric Fingers',price:'$3.9/kg – Free Delivery',desc:'High color turmeric.'},
      {id:'b-3',img:'best-joha-1.jpg',title:'Joha Rice Premium',price:'$2.0/kg – Free Delivery',desc:'Premium aromatic rice.'},
      {id:'b-4',img:'best-cardamom-1.jpg',title:'Cardamom Premium',price:'$24/kg – Free Delivery',desc:'Top-grade green cardamom.'},
      {id:'b-5',img:'best-cinnamon-1.jpg',title:'Cinnamon Sticks',price:'$15/kg – Free Delivery',desc:'Hand-selected sticks.'},
      {id:'b-6',img:'best-cloves-1.jpg',title:'Cloves (Export)',price:'$18/kg – Free Delivery',desc:'Cleaned and dried.'},
      {id:'b-7',img:'best-blackgram-1.jpg',title:'Black Gram Split',price:'$2.8/kg – Free Delivery',desc:'Split urad dal for processors.'},
      {id:'b-8',img:'best-bay-1.jpg',title:'Bay Leaf Whole',price:'$5/kg – Free Delivery',desc:'Aromatic bay leaf.'},
      {id:'b-9',img:'best-star-1.jpg',title:'Star Anise (Bulk)',price:'$12/kg – Free Delivery',desc:'Uniform sizing.'},
    ]
  },
  {
    id:'regional',
    ...
    products:[
      {id:'r-1',img:'reg-ghost-1.jpg',title:'Smoked Ghost Pepper',price:'$49/kg – Free Delivery',desc:'Smoky heat profile.'},
      {id:'r-2',img:'reg-turmeric-1.jpg',title:'High Curcumin Turmeric',price:'$3.9/kg – Free Delivery',desc:'Distinctive Lakadong variety.'},
      {id:'r-3',img:'reg-joha-1.jpg',title:'Fragrant Joha Rice',price:'$1.5/kg – Free Delivery',desc:'Short-grain aromatic rice.'},
      {id:'r-4',img:'reg-cardamom-2.jpg',title:'Small Cardamom',price:'$20/kg – Free Delivery',desc:'Wild-harvested notes.'},
      {id:'r-5',img:'reg-blackgram-1.jpg',title:'Organic Black Gram',price:'$2.8/kg – Free Delivery',desc:'Organically farmed.'},
      {id:'r-6',img:'reg-bamboo-shoot.jpg',title:'Pickled Bamboo Shoot (Dry)',price:'$3/kg – Free Delivery',desc:'For ethnic cuisines.'},
      {id:'r-7',img:'reg-japi.jpg',title:'Japi Herb Blend',price:'$6/kg – Free Delivery',desc:'Traditional aromatic mix.'},
      {id:'r-8',img:'reg-ginger.jpg',title:'Dry Ginger',price:'$2.5/kg – Free Delivery',desc:'Good for chai and extracts.'},
      {id:'r-9',img:'reg-naga-mustard.jpg',title:'Naga Mustard Seeds',price:'$4/kg – Free Delivery',desc:'Spicy regional condiment.'},
    ]
  },
  {
    id:'superfoods',
    ...
    products:[
      ...
      {id:'s-4',img:'super-millet.jpg',title:'Finger Millet',price:'$2/kg – Free Delivery',desc:'Ancient grain, rich calcium.'},
      ...
      {id:'s-6',img:'super-flax.jpg',title:'Flax Seeds',price:'$3/kg – Free Delivery',desc:'Good for baking and oils.'},
      {id:'s-7',img:'super-honeypowder.jpg',title:'Honey Powder',price:'$7/kg – Free Delivery',desc:'Stable sweetener for blends.'},
      {id:'s-8',img:'super-turmeric-powder.jpg',title:'Turmeric Powder',price:'$3.9/kg – Free Delivery',desc:'Processed & sieved.'},
      {id:'s-9',img:'super-beetroot.jpg',title:'Beetroot Powder',price:'$5/kg – Free Delivery',desc:'Natural colorant & supplement.'},
    ]
  },
  {
    id:'new',
    ...
    products:[
      ...
      {id:'n-5',img:'new-card-2.jpg',title:'Cardamom (Green)',price:'$23/kg – Free Delivery',desc:'Premium grade.'},
      {id:'n-6',img:'new-masala.jpg',title:'Custom Masala Blend',price:'$6/kg – Free Delivery',desc:'Private label mixes.'},
      {id:'n-7',img:'new-dates.jpg',title:'Dates (Deglet Noor)',price:'$4/kg – Free Delivery',desc:'Natural sweeteners.'},
      {id:'n-8',img:'new-tea.jpg',title:'Assam Loose Leaf',price:'$3.5/kg – Free Delivery',desc:'Single-estate teas.'},
      {id:'n-9',img:'new-cocoa.jpg',title:'Raw Cocoa Nibs',price:'$7/kg – Free Delivery',desc:'For specialty food brands.'},
    ]
  }
];
